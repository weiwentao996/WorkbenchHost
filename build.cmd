...
"%CSC%" /nologo /target:winexe /optimize+ /out:"%~dp0.\WorkbenchHost.exe" /win32icon:"%~dp0icon.ico" /resource:"%~dp0assets\codicon.ttf",WorkbenchHost.codicon.ttf /reference:System.dll /reference:System.Drawing.dll /reference:System.Windows.Forms.dll /reference:System.Web.Extensions.dll "%~dp0Program.cs" "%~dp0Profile.cs" "%~dp0ProfileImporter.cs" "%~dp0WorkspaceState.cs" "%~dp0NativeMethods.cs" "%~dp0WorkbenchTheme.cs" "%~dp0CodePanel.cs" "%~dp0QuickImportDialog.cs" "%~dp0MainForm.cs"
